...
<body>
<a href="/admin?method=return&page=1">handle returned books</a>
<table class="table">
    <tr>
        <td>id</td>
        <td>name</td>
    ...
    <c:forEach items="${list}" var="borrow">
        <tr>
            ...
            <td>
                <a href="/admin?method=handle&state=1&id=${borrow.id}">refuse</a>
                <a href="/admin?method=handle&state=2&id=${borrow.id}">agree</a>
            </td>
        </tr>
    </c:forEach>
</table>
